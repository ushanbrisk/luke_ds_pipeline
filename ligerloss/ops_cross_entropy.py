...
def liger_cross_entropy_kernel(
    ...
    #added by luke
    # add kl regulator
    log_ps_ref = ori_X_y_ref - lse_ref
    log_ps = ori_X_y - lse
    kl_penalty_coeff = (tl.exp(log_ps_ref - log_ps)-1)*beta
    #end of kl regulator
    ...
    for i in range(0, n_cols, BLOCK_SIZE):
        ...
        if not HAS_WEIGHT:
            ...
            # ref_X1_block += 2 * lse_square_scale * lse_ref * ref_X1_block
            ...
            X_block = tl.where(X_offsets != y, (kl_penalty_coeff + 1)* X_block, (kl_penalty_coeff + 1)*(X_block - (1 - label_smoothing)))
            # ref_X1_block = tl.where(X_offsets != y, ref_X1_block, ref_X1_block - (1 - label_smoothing))
            # reduction scale
            ...
            if reduction == "mean":
                ...
                # ref_X1_block = ref_X1_block / n_non_ignore
